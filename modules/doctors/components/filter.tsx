...
const Filter: React.FC = () => {
    ...
    const otherFilters = <React.Fragment>
        ...
        <div className={`item ${controller.activeFilters.includes("Город") ? "active" : ""}`}>
            <div id={"city"} className="title" onClick={() => {
                controller.isSelectCityModalOpen = true;
            }}>
                <h5>Город</h5>
            </div>
        </div>
            ...
            <div className="row">
                ...
                <div className="sort-by">
                    ...
                    <div className="selector"
                         onClick={() => controller.sortByFilterOpen = !controller.sortByFilterOpen}>
                        {controller.sortBy}
                        <CaretteDown/>
                ...
                <div onClick={controller.clickOnDownward}
                     className={`downward-upward ${controller.isDownward ? "" : "upward"}`}>
