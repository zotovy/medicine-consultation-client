...
class MochaAdapter {
  ...
  formatMessage(params) {
    ...
    if (params.err) {
      if (params.err && params.err.message && params.err.message.includes(_constants.MOCHA_TIMEOUT_MESSAGE)) {
        const replacement = (0, _util.format)(_constants.MOCHA_TIMEOUT_MESSAGE_REPLACEMENT, params.payload.parent.title, params.payload.title);
        params.err.message = params.err.message.replace(_constants.MOCHA_TIMEOUT_MESSAGE, replacement);
        params.err.stack = params.err.stack.replace(_constants.MOCHA_TIMEOUT_MESSAGE, replacement);
      }
