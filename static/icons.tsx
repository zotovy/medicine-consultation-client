...
export const FullStar: React.FC<any> = ({ fill, className, id, onClick }) => {
    return <svg xmlns="http://www.w3.org/2000/svg" className={className} id={id} onClick={onClick} width="25" height="23.214" viewBox="0 0 25 23.214">
