...
export const FullStar: React.FC<{ fill: string, className?: string, id?: string }> = ({ fill, className, id }: { fill: string, className?: string, id?: string }) => {
    return <svg xmlns="http://www.w3.org/2000/svg" className={className} id={id} width="25" height="23.214" viewBox="0 0 25 23.214">
