...
export const MicroIcon: React.FC = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="24.75" height="36" viewBox="0 0 24.75 36">
...
export const MicroSlashIcon: React.FC = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="45" height="36" viewBox="0 0 45 36">
        <path id="Icon_awesome-microphone-slash" data-name="Icon awesome-microphone-slash" d="M44.565,32.21l-11.1-8.575A12.083,12.083,0,0,0,34.875,18V14.625A1.125,1.125,0,0,0,33.75,13.5H32.625A1.125,1.125,0,0,0,31.5,14.625V18a8.745,8.745,0,0,1-.754,3.53l-1.867-1.443A6.619,6.619,0,0,0,29.251,18V6.75a6.75,6.75,0,1,0-13.5,0V9.939L3.2.237a1.126,1.126,0,0,0-1.579.2L.237,2.211a1.125,1.125,0,0,0,.2,1.579L41.8,35.763a1.125,1.125,0,0,0,1.579-.2l1.381-1.777a1.126,1.126,0,0,0-.2-1.579Zm-16.44.415H24.188V30.251a12.243,12.243,0,0,0,2.367-.584l-3.523-2.723a9.067,9.067,0,0,1-1.431.014A9.106,9.106,0,0,1,13.783,19.8l-3.658-2.829v.482A12.762,12.762,0,0,0,20.813,30.224v2.4H16.875A1.125,1.125,0,0,0,15.75,33.75v1.125A1.125,1.125,0,0,0,16.875,36h11.25a1.125,1.125,0,0,0,1.125-1.125V33.75A1.125,1.125,0,0,0,28.125,32.625Z" transform="translate(0)" fill="#fff" />
    </svg>
}

export const CameraIcon: React.FC = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="36" height="30" viewBox="0 0 36 30">
        <g id="Icon_feather-camera" data-name="Icon feather-camera" transform="translate(0 -3)">
            <path id="Контур_14" data-name="Контур 14" d="M34.5,28.5a3,3,0,0,1-3,3H4.5a3,3,0,0,1-3-3V12a3,3,0,0,1,3-3h6l3-4.5h9l3,4.5h6a3,3,0,0,1,3,3Z" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
            <path id="Контур_15" data-name="Контур 15" d="M24,19.5a6,6,0,1,1-6-6A6,6,0,0,1,24,19.5Z" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" />
        </g>
    </svg>
}

export const LeaveCallIcon: React.FC = () => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="36" height="13.29" viewBox="0 0 36 13.29">
        <path id="Icon_material-call-end" d="M18,13.5a22.366,22.366,0,0,0-6.9,1.08v4.65a1.511,1.511,0,0,1-.84,1.35,17.266,17.266,0,0,0-3.99,2.775,1.473,1.473,0,0,1-1.05.42,1.5,1.5,0,0,1-1.065-.435L.435,19.62A1.435,1.435,0,0,1,0,18.57a1.5,1.5,0,0,1,.435-1.065,25.525,25.525,0,0,1,35.13,0,1.521,1.521,0,0,1,0,2.13l-3.72,3.72a1.5,1.5,0,0,1-1.065.435,1.539,1.539,0,0,1-1.05-.42A16.906,16.906,0,0,0,25.725,20.6a1.494,1.494,0,0,1-.84-1.35V14.6A21.773,21.773,0,0,0,18,13.5Z" transform="translate(0 -10.5)" fill="#fdffff"/>
    </svg>
}
