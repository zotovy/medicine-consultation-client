...
var SymptomsPage = function () {
    var handlerClick = symptoms_controller_1["default"].handlerClick, doctors = symptoms_controller_1["default"].doctors, cloneDoctors = mobx_1.toJS(doctors);
        ...
        symptoms_controller_1["default"].canFindDoctors === true
            ?
                cloneDoctors.length !== 0
                    ...
                    :
                        react_1["default"].createElement(react_router_dom_1.Redirect, { from: "/", to: "/symp-error" })
            :
