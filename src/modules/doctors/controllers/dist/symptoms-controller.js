...
var SympController = /** @class */ (function () {
    function SympController() {
        ...
        this.choiseSymp = function (e, id) {
            e.persist();
            _this.symptoms = _this.symptoms.map(function (item, i) {
        ...
        this._fetchDoctors = function (bodyParts) { return __awaiter(_this, void 0, Promise, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1["default"]
                            .get.apply(axios_1["default"], __spreadArrays([process.env.REACT_APP_SERVER_URL +
                                ("/api/symptoms?bodyPart=" + )], bodyParts.map(function (item) { return item.name; })))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/];
                }
