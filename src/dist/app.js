...
var SettingsAccountPage = react_1.lazy(function () { return Promise.resolve().then(function () { return require("./modules/settings"); }).then(function (module) { return ({ "default": module.SettingsAccountPage }); }); });
var SettingsConsultationPage = react_1.lazy(function () { return Promise.resolve().then(function () { return require("./modules/settings"); }).then(function (module) { return ({ "default": module.SettingsConsultationPage }); }); });
var SettingsReviewPage = react_1.lazy(function () { return Promise.resolve().then(function () { return require("./modules/settings"); }).then(function (module) { return ({ "default": module.SettingsReviewPage }); }); });
var SettingsNotificationPage = react_1.lazy(function () { return Promise.resolve().then(function () { return require("./modules/settings"); }).then(function (module) { return ({ "default": module.SettingsNotificationPage }); }); });
var SettingsPasswordPage = react_1.lazy(function () { return Promise.resolve().then(function () { return require("./modules/settings"); }).then(function (module) { return ({ "default": module.SettingsPasswordPage }); }); });
